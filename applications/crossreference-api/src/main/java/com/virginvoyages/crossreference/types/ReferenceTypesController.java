...
public class ReferenceTypesController {
    ...
    @RequestMapping(value = "/types/{referenceTypeID}",
	...
	@ApiOperation(value = "Find reference type by ID", notes = "Returns a reference source for a specified reference source identity.  This identity is a univeral reference identity.", response = ReferenceType.class, tags={ "ReferenceType", })
    @ApiResponses(value = { 
	...
	@ApiOperation(value = "", notes = "Update a `ReferenceType` object.", response = Void.class, tags={ "ReferenceType", })
    @ApiResponses(value = { 
