...
@XmlSeeAlso({
    com.virginvoyages.seaware.data.AirSearchPrefsType.VendorPref.class,
    com.virginvoyages.seaware.data.VehicleAvailRQCoreType.VendorPrefs.VendorPref.class,
    com.virginvoyages.seaware.data.AirlinePrefType.VendorPref.class
})
