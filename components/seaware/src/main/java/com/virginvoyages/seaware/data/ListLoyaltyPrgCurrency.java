...
@XmlSeeAlso({
    com.virginvoyages.seaware.data.CodeListFeeType.Amount.AlternateCurrency.class,
    com.virginvoyages.seaware.data.CodeListFeeType.Taxes.Amount.AlternateCurrency.class
})
