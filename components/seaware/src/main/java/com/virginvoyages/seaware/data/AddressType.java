...
@XmlSeeAlso({
    com.virginvoyages.seaware.data.RailPersonInfoType.Address.class,
    com.virginvoyages.seaware.data.DonationType.DonorInfo.ContactInfo.class,
    com.virginvoyages.seaware.data.RailPassengerDetailType.Address.class,
    com.virginvoyages.seaware.data.OffLocationServiceCoreType.Address.class,
    com.virginvoyages.seaware.data.ItemSearchCriterionType.Address.class,
    AddressInfoType.class,
    com.virginvoyages.seaware.data.AirTravelerType.Address.class
})
