...
@XmlSeeAlso({
    ...
    com.virginvoyages.seaware.data.BaggageQueryType.AirlineCarrier.class,
    com.virginvoyages.seaware.data.AllianceConsortiumType.AllianceMember.class,
    com.virginvoyages.seaware.data.DirectBillType.CompanyName.class,
    com.virginvoyages.seaware.data.VehicleAvailCoreType.Vendor.class,
    CompanyNamePrefType.class,
    TravelArrangerType.class,
    com.virginvoyages.seaware.data.FlightSegmentType.MarketingAirline.class,
    com.virginvoyages.seaware.data.PaymentFormType.Voucher.BillingAccountName.class
})
