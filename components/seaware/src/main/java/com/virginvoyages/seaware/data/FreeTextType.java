...
@XmlSeeAlso({
    com.virginvoyages.seaware.data.OTACancelRQ.Reasons.Reason.class,
    com.virginvoyages.seaware.data.IndCoverageReqsType.PreexistingConditions.PreexistingCondition.class,
    com.virginvoyages.seaware.data.PTCFareBreakdownType.Endorsements.Endorsement.class,
    CertificationType.class,
    com.virginvoyages.seaware.data.FareCodeOptionType.FareRemark.class,
    ErrorType.class,
    WarningType.class,
    com.virginvoyages.seaware.data.TicketingInfoType.TicketAdvisory.class,
