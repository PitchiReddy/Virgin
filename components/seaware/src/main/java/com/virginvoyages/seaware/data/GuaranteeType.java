...
@XmlSeeAlso({
    com.virginvoyages.seaware.data.BookingRulesType.BookingRule.AcceptableGuarantees.AcceptableGuarantee.class,
    com.virginvoyages.seaware.data.RatePlanType.Guarantee.class
})
