...
@XmlSeeAlso({
    com.virginvoyages.seaware.data.CruiseGuestInfoType.LinkedBookings.LinkedBooking.class,
    com.virginvoyages.seaware.data.CruiseGuestDetailType.LinkedTraveler.class
})
