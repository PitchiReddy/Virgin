...
public class OTACruiseInfoRQ {

    @XmlElement(name = "POS", required = true)
    protected POSType pos;
    @XmlElement(name = "InformationType", required = true)
    protected List<OTACruiseInfoRQ.InformationType> informationType;
     ...
     * {@link OTACruiseInfoRQ.InformationType }
     * 
     * 
     */
    public List<OTACruiseInfoRQ.InformationType> getInformationType() {
        if (informationType == null) {
            informationType = new ArrayList<OTACruiseInfoRQ.InformationType>();
        }
