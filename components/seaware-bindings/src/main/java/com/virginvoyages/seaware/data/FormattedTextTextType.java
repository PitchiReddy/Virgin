...
@XmlSeeAlso({
    com.virginvoyages.seaware.data.FulfillmentType.PaymentText.class,
    com.virginvoyages.seaware.data.VehicleRentalDetailsType.ConditionReport.class,
    com.virginvoyages.seaware.data.ImageDescriptionType.Description.class,
    com.virginvoyages.seaware.data.TextDescriptionType.Description.class,
    com.virginvoyages.seaware.data.ParagraphType.ListItem.class,
    com.virginvoyages.seaware.data.RateQualifierType.RateComments.RateComment.class,
    com.virginvoyages.seaware.data.VideoDescriptionType.Description.class,
    com.virginvoyages.seaware.data.TravelerInfoType.AirTraveler.Comment.class,
