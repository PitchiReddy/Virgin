...
@XmlSeeAlso({
    com.virginvoyages.seaware.data.CompanyInfoType.AddressInfo.class,
    com.virginvoyages.seaware.data.RequiredPaymentsType.GuaranteePayment.Address.class,
    com.virginvoyages.seaware.data.CustomerType.Address.class,
    com.virginvoyages.seaware.data.AddressesType.Address.class
})
