...
@XmlSeeAlso({
    com.virginvoyages.seaware.data.VehicleAgeRequirementsType.Age.AgeInfos.AgeInfo.class,
    VendorMessageType.class,
    VehicleLocationInformationType.class,
    com.virginvoyages.seaware.data.VehicleLocationVehiclesType.VehicleInfos.VehicleInfo.class,
    com.virginvoyages.seaware.data.VehicleAdditionalDriverRequirementsType.AddlDriverInfos.AddlDriverInfo.class,
    com.virginvoyages.seaware.data.VehicleLocationAdditionalDetailsType.Shuttle.ShuttleInfos.ShuttleInfo.class
})
