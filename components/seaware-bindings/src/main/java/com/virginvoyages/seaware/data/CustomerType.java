...
@XmlSeeAlso({
    com.virginvoyages.seaware.data.CustomerPrimaryAdditionalType.Primary.class,
    com.virginvoyages.seaware.data.CustomerPrimaryAdditionalType.Additional.class,
