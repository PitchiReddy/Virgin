 ...
 *                 &lt;attribute name="ColorSpace" type="{http://www.opentravel.org/OTA/2003/05}StringLength1to64" />
 *                 &lt;attribute name="Latitude" type="{http://www.opentravel.org/OTA/2003/05}StringLength1to16" />
 *                 &lt;attribute name="Longitude" type="{http://www.opentravel.org/OTA/2003/05}StringLength1to16" />
 *                 &lt;attribute name="OriginalFileName" type="{http://www.opentravel.org/OTA/2003/05}StringLength1to64" />
 *               &lt;/extension>
 *             &lt;/complexContent>
 *           &lt;/complexType>
 *         &lt;/element>
...
@XmlSeeAlso({
    com.virginvoyages.seaware.data.AirPricedOfferType.Multimedia.class,
    com.virginvoyages.seaware.data.ImageItemsType.ImageItem.class
})
