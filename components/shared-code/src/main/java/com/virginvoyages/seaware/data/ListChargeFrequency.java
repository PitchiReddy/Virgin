...
@XmlSeeAlso({
    com.virginvoyages.seaware.data.CodeListFeeType.Qualifiers.ChargeUnit.Frequency.class,
    com.virginvoyages.seaware.data.CodeListFeeType.Taxes.Qualifiers.ChargeUnit.Frequency.class
})
