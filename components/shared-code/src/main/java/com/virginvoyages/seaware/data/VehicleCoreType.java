...
@XmlSeeAlso({
    com.virginvoyages.seaware.data.VehicleAgeRequirementsType.Age.Vehicles.Vehicle.class,
    VehiclePrefType.class,
    VehicleType.class,
    com.virginvoyages.seaware.data.VehicleAdditionalDriverRequirementsType.AddlDriverInfos.Vehicles.Vehicle.class
})
