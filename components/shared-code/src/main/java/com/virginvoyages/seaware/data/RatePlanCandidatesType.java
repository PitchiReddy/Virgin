...
@XmlSeeAlso({
    com.virginvoyages.seaware.data.HotelSearchCriterionType.RatePlanCandidates.class
})
public class RatePlanCandidatesType {
    ...
    public static class RatePlanCandidate {
        ...
        /**
         * Gets the value of the ratePlanFilterCode property.
         * 
         * @return
         *     possible object is
         *     {@link String }
        ...
        /**
         * Sets the value of the ratePlanFilterCode property.
         * 
         * @param value
         *     allowed object is
         *     {@link String }
