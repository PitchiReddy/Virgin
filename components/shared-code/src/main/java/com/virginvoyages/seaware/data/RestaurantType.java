...
@XmlSeeAlso({
    com.virginvoyages.seaware.data.OTACruiseDiningAvailRS.DiningOptions.DiningOption.DiningRoom.class,
    com.virginvoyages.seaware.data.OTACruiseDiningAvailRQ.DiningRoom.class
})
