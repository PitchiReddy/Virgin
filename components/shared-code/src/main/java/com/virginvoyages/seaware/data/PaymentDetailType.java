...
@XmlSeeAlso({
    com.virginvoyages.seaware.data.OTACruisePaymentRS.ReservationPayment.PaymentDetail.class,
    com.virginvoyages.seaware.data.CruiseGuestInfoType.PaymentOptions.PaymentOption.class,
    com.virginvoyages.seaware.data.FulfillmentType.PaymentDetails.PaymentDetail.class,
    com.virginvoyages.seaware.data.VehicleReservationRQAdditionalInfoType.RentalPaymentPref.class
})
