...
@XmlSeeAlso({
    com.virginvoyages.seaware.data.CodeListFeeType.Qualifiers.ChargeUnit.Unit.class,
    com.virginvoyages.seaware.data.CodeListFeeType.Taxes.Qualifiers.ChargeUnit.Unit.class
})
