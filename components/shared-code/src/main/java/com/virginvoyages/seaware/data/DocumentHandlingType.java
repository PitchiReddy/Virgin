...
@XmlSeeAlso({
    com.virginvoyages.seaware.data.OTACruiseBookingDocumentRQ.CruiseDocument.class,
    com.virginvoyages.seaware.data.OTACruiseBookingDocumentRS.CruiseDocument.class
})
