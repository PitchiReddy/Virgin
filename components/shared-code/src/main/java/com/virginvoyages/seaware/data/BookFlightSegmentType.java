...
@XmlSeeAlso({
    com.virginvoyages.seaware.data.PTCFareBreakdownType.PricingUnit.FareComponent.FlightLeg.class,
    com.virginvoyages.seaware.data.OriginDestinationOptionType.FlightSegment.class
})
