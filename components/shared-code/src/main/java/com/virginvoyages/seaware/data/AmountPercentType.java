...
@XmlSeeAlso({
    com.virginvoyages.seaware.data.RequiredPaymentsType.GuaranteePayment.AmountPercent.class,
    com.virginvoyages.seaware.data.RatePlanType.Guarantee.AmountPercent.class
})
