...
/**
 * Provides formatted textual information relating to the vehicle rental location.  The type of information is indicated in the @Type attribute that contains a value from the OpenTravel Vehicle Location Information Type (VLI) code list.
 * 
